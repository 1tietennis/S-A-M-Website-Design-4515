    ...
    <div className="min-h-screen pt-20">
      ...
      <section ref={heroRef} className="hero-bg py-20 relative overflow-hidden">
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              <SafeIcon icon={FiVideo} className="text-tactical-red" />
              <span className="text-tactical-red font-semibold">Mission: Captivate</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl font-display font-bold mb-6">
              <span className="glow-text">Video Marketing</span>
              <br />
      ...
      <section ref={statsRef} className="py-16 bg-tactical-red">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <div className="inline-flex items-center space-x-4 px-6 py-3 bg-white/10 rounded-lg backdrop-blur-sm">
              <SafeIcon icon={FiTrendingUp} className="text-white text-2xl" />
              <span className="text-white text-lg font-semibold">
                Over 83% of viewers remember a brand better with video—don't miss your shot.
              </span>
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              { number: '83%', label: 'Better Brand Recall' },
              { number: '5x', label: 'Higher Engagement' },
                ...
                <div className="grid grid-cols-2 gap-4">
                  {service.features.map((feature, featureIndex) => (
                    <div key={featureIndex} className="flex items-center space-x-2">
                      <SafeIcon icon={FiCheck} className="text-tactical-red text-sm" />
      ...
      <section className="py-20 bg-jet-black">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-8">
              <span className="gradient-text">Bundle Packages</span> Available
            </h2>
            <p className="text-xl text-gray-300">Save big with our comprehensive video marketing packages</p>
          </motion.div>
            ...
            {bundles.map((bundle, index) => (
              ...
              >
                ...
                <div className="text-center mb-6">
                  ...
                  <div className="mb-2">
                    <span className="text-4xl font-display font-bold text-tactical-red">{bundle.price}</span>
                ...
                <ul className="space-y-3 mb-8">
                  {bundle.includes.map((item, itemIndex) => (
                    <li key={itemIndex} className="flex items-center space-x-2">
                      <SafeIcon icon={FiCheck} className="text-tactical-red" />
      ...
      <section className="py-20 bg-dark-gray">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-8">
              Why Choose Our <span className="text-tactical-red">Videos?</span>
            </h2>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <SafeIcon icon={reason.icon} className="text-tactical-red text-4xl mb-4 mx-auto" />
