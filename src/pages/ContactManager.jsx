...
const { 
  FiUsers, FiSearch, FiFilter, FiChevronDown, FiChevronUp, FiMail, 
  FiPhone, FiDollarSign, FiClock, FiStar, FiCheck, FiX, 
...
const ContactManager = () => {
  ...
  const renderStatusBadge = (status) => {
    let colorClass = '';
    switch(status) {
      case 'new': colorClass = 'bg-blue-500'; break;
      case 'contacted': colorClass = 'bg-yellow-500'; break;
      case 'qualified': colorClass = 'bg-green-500'; break;
      case 'unqualified': colorClass = 'bg-red-500'; break;
      case 'converted': colorClass = 'bg-purple-500'; break;
